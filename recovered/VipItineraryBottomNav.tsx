...
import { BedDouble, Home, Map, Ticket } from 'lucide-react'

export type ItineraryMainTab = 'overview' | 'itinerary' | 'hotels' | 'activities'
...
const TABS: { id: ItineraryMainTab; label: string; Icon: typeof Home }[] = [
  ...
  { id: 'hotels', label: '\u0627\u0644\u0641\u0646\u0627\u062f\u0642', Icon: BedDouble },
  { id: 'activities', label: '\u0627\u0644\u0641\u0639\u0627\u0644\u064a\u0627\u062a', Icon: Ticket },
]
...
export default function VipItineraryBottomNav({ activeTab, onTabChange }: VipItineraryBottomNavProps) {
  return (
    ...
    >
      <div className="mx-auto grid max-w-lg grid-cols-4 gap-1 px-2 sm:max-w-xl">
