...
/** Verified client token — bypasses Next.js env inlining issues */
const MAPBOX_TOKEN =
  'pk.eyJ1IjoiMDU5NzM0OTk0MSIsImEiOiJjbXBhYWlpdDcwZXVhMnFwY3dzajJxaHBtIn0.-ZeXpthWzYte91z9CNz4-Q'
