...
export type OnboardingDnaClientProps = {
  token: string;
  view: WelcomeDnaView;
...
export function OnboardingDnaClient({
  token,
  view,
  errorMessage = null,
  profile = null,
}: OnboardingDnaClientProps) {
  ...
  const [form, setForm] = useState(() => ({
    birth_date: initialForm.birth_date,
    anniversary_date: initialForm.anniversary_date,
